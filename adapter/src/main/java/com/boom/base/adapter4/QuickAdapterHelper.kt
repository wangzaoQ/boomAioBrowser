...
import com.boom.base.adapter4.loadState.leading.DefaultLeadingLoadStateAdapter
import com.boom.base.adapter4.loadState.leading.LeadingLoadStateAdapter
...
class QuickAdapterHelper private constructor(
    ...
    class Builder(private val contentAdapter: BaseQuickAdapter<*, *>) {
        ...
        fun setTrailingLoadStateAdapter(
            ...
            com.boom.base.adapter4.loadState.trailing.DefaultTrailingLoadStateAdapter().apply {
