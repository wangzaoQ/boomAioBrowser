...
//            database.execSQL("ALTER TABLE download_tab ADD completeTime INTEGER NOT NULL DEFAULT 0")
            database.execSQL("ALTER TABLE 'download_tab' ADD COLUMN 'completeTime' INTEGER NOT NULL DEFAULT 0")
