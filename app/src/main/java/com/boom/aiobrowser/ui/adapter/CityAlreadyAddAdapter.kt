...
class CityAlreadyAddAdapter() : BaseQuickAdapter<LocationData, CityAlreadyAddAdapter.VH>() {
    class VH(parent: ViewGroup, val viewBinding: BrowserItemAlreadyCityBinding = BrowserItemAlreadyCityBinding.inflate(
