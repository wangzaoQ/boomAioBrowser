...
import com.boom.drag.WARN_ACTIVITY_NULL
import com.boom.drag.anim.AnimatorManager
import com.boom.drag.data.FloatConfig
import com.boom.drag.enums.ShowPattern
import com.boom.drag.interfaces.OnFloatTouchListener
import com.boom.drag.utils.DisplayUtils
import com.boom.drag.utils.InputMethodUtils
import com.boom.drag.utils.LifecycleUtils
import com.boom.drag.utils.Logger
import com.boom.drag.widget.ParentFrameLayout
            ...
            .enterAnim()?.apply {
                ...
                addListener(object : Animator.AnimatorListener {
                    ...
                    override fun onAnimationStart(animation: Animator) {
                        floatingView.postDelayed(Runnable { floatingView.visibility = View.VISIBLE },100)
                        config.isAnim = true
                    }
                })
